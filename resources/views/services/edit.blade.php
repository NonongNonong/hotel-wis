...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h5 class="fw-semibold mb-0">Edit Service</h5>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="availability"
                        ...
                        <option value="Available"   {{ old('availability', $service->availability) == 'Available'   ? 'selected' : '' }}>Available</option>
                        <option value="Unavailable" {{ old('availability', $service->availability) == 'Unavailable' ? 'selected' : '' }}>Unavailable</option>
                    </select>
                    @error('availability')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror

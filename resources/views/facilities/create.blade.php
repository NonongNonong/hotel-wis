...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h5 class="fw-semibold mb-0">Add New Facility</h5>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="facility_category"
                        ...
                        <option value="Recreation"  {{ old('facility_category') == 'Recreation'  ? 'selected' : '' }}>Recreation</option>
                        <option value="Events"      {{ old('facility_category') == 'Events'      ? 'selected' : '' }}>Events</option>
                        <option value="Dining"      {{ old('facility_category') == 'Dining'      ? 'selected' : '' }}>Dining</option>
                        <option value="Wellness"    {{ old('facility_category') == 'Wellness'    ? 'selected' : '' }}>Wellness</option>
                        <option value="Business"    {{ old('facility_category') == 'Business'    ? 'selected' : '' }}>Business</option>
                        <option value="Other"       {{ old('facility_category') == 'Other'       ? 'selected' : '' }}>Other</option>
                    </select>

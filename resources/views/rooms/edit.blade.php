...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h5 class="fw-semibold mb-0">Edit Room</h5>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="base_rate" step="0.01"
                           ...
                           value="{{ old('base_rate', $room->base_rate) }}" min="0">
                    @error('base_rate')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea name="room_details" rows="3"
                              class="form-control @error('room_details') is-invalid @enderror">{{ old('room_details', $room->room_details) }}</textarea>
                    @error('room_details')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
